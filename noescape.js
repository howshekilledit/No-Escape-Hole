...
$(document).ready(function(){
	...
	var bodycont = '<h1 id = "noescape">no escape hole</h1><h2 id="mmenu">menu</h2><div id="nav" style="vertical-align:top">' + nav + '</div> <div id="content"> <img id="thumb" src="http://greenmorgan.com/noescapehole/assets/loading.jpeg" class=""> <div id="artist">		</div> <div class = "homeinst" id="instr"> ' + instr + '</div> </div>';
...
function rollworks(a, works, instr){
	...
	$('#thumb').attr('src', 'http://greenmorgan.com/noescapehole/assets/'+works[a].thumb); 
...
works[9].html =  '<div id = "scroll" ><div id = "jenna" width = "100%" ><!--img src = "http://greenmorgan.com/noescapehole/assets/textlong.png" width = "100%"--></div></div>';
...
works[9].onclick = function(){ //Jenna
	...
	//	alert(height); 
		//$('#scroll').append('<img src = "http://greenmorgan.com/noescapehole/assets/textlong.png" width = "100%" style = "margin-top:-8px">'); 
	});
...
works[10].html = '<video autoplay width="100%" controls><source src="http://greenmorgan.com/noescapehole/assets/chika-720.mp4" type="video/mp4">Your browser does not support the video tag.</video>';
