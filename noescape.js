...
$(document).ready(function(){
	...
	var bodycont = '<h1 id = "noescape">no escape hole</h1><h2 id="mmenu">menu</h2><div id="nav" style="vertical-align:top">' + nav + '</div> <div id="content"> <img id="thumb" src="https://raw.githubusercontent.com/howshekilledit/No-Escape-Hole/assets/loading.jpeg" class=""> <div id="artist">		</div> <div class = "homeinst" id="instr"> ' + instr + '</div> </div>';
...
function rollworks(a, works, instr){
	...
	$('#thumb').attr('src', 'https://raw.githubusercontent.com/howshekilledit/No-Escape-Hole/assets/'+works[a].thumb); 
...
works[9].html =  '<div id = "scroll" ><div id = "jenna" width = "100%" ><!--img src = "https://raw.githubusercontent.com/howshekilledit/No-Escape-Hole/assets/textlong.png" width = "100%"--></div></div>';
...
works[9].onclick = function(){ //Jenna
	...
	//	alert(height); 
		//$('#scroll').append('<img src = "https://raw.githubusercontent.com/howshekilledit/No-Escape-Hole/assets/textlong.png" width = "100%" style = "margin-top:-8px">'); 
	});
...
works[0].html = '<img class ="joo" src ="https://raw.githubusercontent.com/howshekilledit/No-Escape-Hole/assets/Water.gif" width = "100%"/><img class = "joo" src = "https://raw.githubusercontent.com/howshekilledit/No-Escape-Hole/assets/jootext.gif" width = "100%" />'+"<div class='embed-container' id = 'joocont' ><iframe src='https://player.vimeo.com/video/298800899?byline=false;title=false;portrait=false;' frameborder='0'  id = 'joovid' webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe></div>";  //Joo
works[0].onclick = function() {//start joo click
	fullscreen(this.html);
		
	$(audioElement).attr('id', 'jooaud'); 
	//var audioElement = $('#jooaud'); 
    audioElement.setAttribute('src', 'https://raw.githubusercontent.com/howshekilledit/No-Escape-Hole/assets/joosound.mp3');
	//while(current === 0){
		audioElement.play(); 
	//}
	fullscreen(this.html);
...
works[10].html = '<video autoplay width="100%" controls><source src="https://raw.githubusercontent.com/howshekilledit/No-Escape-Hole/assets/chika-720.mp4" type="video/mp4">Your browser does not support the video tag.</video>';
